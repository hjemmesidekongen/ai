...
**[Install](/docs/install)** the plugins, **[configure](/docs/configure)** your MCP connections, and **[initialize](/docs/init-project)** your first project. Each guide walks through the full setup.
