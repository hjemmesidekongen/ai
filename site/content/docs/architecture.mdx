...
- [claude-core](/docs/claude-core) - the foundation plugin with hooks, verification, and state management
- [dev-engine](/docs/dev-engine) - the development execution pipeline and agent model
- [taskflow](/docs/taskflow) - task lifecycle and MCP integrations
