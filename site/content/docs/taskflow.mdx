...
- [claude-core](/docs/claude-core) - the foundation plugin that provides MCP skills and session continuity
- [dev-engine](/docs/dev-engine) - the execution pipeline that consumes task context from taskflow
- [Workflows](/docs/workflows) - end-to-end recipes using taskflow commands
