...
```
Read team-state.yml → decomposition.components
...
- Designer specs from decomposition (if present)
...
- **Frontend Worker:** All other frontend implementation tasks
...
|------|-------|------|------|-------|
| T1   | frontend-worker | senior | medium | 3 files |
...
Ready for Phase 3 (execution). Run /dev:build to continue.
```
