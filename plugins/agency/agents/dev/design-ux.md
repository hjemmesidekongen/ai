...
color: yellow
capabilities:
  - "Design spec to implementation guidance translation"
  - "Accessibility pattern definition and responsive strategy"
  - "Design system enforcement and token usage validation"
