...
- **9 skills**: jira-ingestion, contradiction-detection, project-profile-loader, qa-handover-generator, confluence-lookup, bitbucket-pr-workflow, azure-devops-pipeline, bulk-ingestion, session-handoff-herold
