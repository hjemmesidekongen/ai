...
ls -d plugins/claude-core/skills/*/SKILL.md | sed 's|.*/skills/||;s|/SKILL.md||' | sort

# Agent names (file basenames)
ls plugins/claude-core/agents/*.md | sed 's|.*/||;s|\.md||' | sort

# Command names (file basenames)
ls plugins/claude-core/commands/*.md | sed 's|.*/||;s|\.md||' | sort
```
...
auto_doc:
  files_updated:
    ...
    - file: "plugins/claude-core/.claude-plugin/ecosystem.json"
