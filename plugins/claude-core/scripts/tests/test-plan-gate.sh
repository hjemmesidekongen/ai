...
# Run: bash plugins/claude-core/scripts/tests/test-plan-gate.sh
...
OUTPUT=$(run_hook '{"tool_name":"Write","tool_input":{"file_path":"/home/user/project/plugins/claude-core/skills/foo/SKILL.md"}}' "$PROJECT") && EC=$? || EC=$?
...
> "$PROJECT/.ai/traces/hook-errors.log"
OUTPUT=$(run_hook '{"tool_name":"Write","tool_input":{"file_path":"/home/user/project/plugins/claude-core/.claude-plugin/ecosystem.json"}}' "$PROJECT") && EC=$? || EC=$?
...
> "$PROJECT/.ai/traces/hook-errors.log"
OUTPUT=$(run_hook '{"tool_name":"Write","tool_input":{"file_path":"/home/user/project/plugins/claude-core/resources/schema.yml"}}' "$PROJECT") && EC=$? || EC=$?
...
> "$PROJECT/.ai/traces/hook-errors.log"
OUTPUT=$(run_hook '{"tool_name":"Write","tool_input":{"file_path":"/home/user/project/plugins/claude-core/scripts/new-hook.sh"}}' "$PROJECT") && EC=$? || EC=$?
