...
# Run: bash plugins/kronen/scripts/tests/test-scope-guard.sh
...
OUTPUT=$(run_hook '{"tool_name":"Write","tool_input":{"file_path":"plugins/kronen/skills/foo/SKILL.md"}}' "$PROJECT") && EC=$? || EC=$?
