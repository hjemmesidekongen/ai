...
```bash
bash plugins/kronen/scripts/worktree-create.sh <name> <branch-name>
```
...
```bash
bash plugins/kronen/scripts/worktree-finish.sh <name> merge
```
...
```bash
bash plugins/kronen/scripts/worktree-finish.sh <name> pr
```
...
```bash
bash plugins/kronen/scripts/worktree-finish.sh <name> keep
```
...
```bash
bash plugins/kronen/scripts/worktree-finish.sh <name> discard
```
