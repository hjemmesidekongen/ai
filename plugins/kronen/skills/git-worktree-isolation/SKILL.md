...
_source:
  ...
  iteration: 1
  changes: "Adapted lifecycle + safety checks to kronen skill format"
---
...
```bash
# Create
bash plugins/kronen/scripts/worktree-create.sh <name> <branch>

# Finish
bash plugins/kronen/scripts/worktree-finish.sh <name> merge|pr|keep|discard
