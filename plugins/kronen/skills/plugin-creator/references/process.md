...
- **dependencies**: list other plugins this one requires (e.g., `["kronen"]`).
...
|---------|-----------|----------|
| Plugin directory | kebab-case | `kronen`, `my-plugin` |
| plugin.json `name` | kebab-case, matches directory | `"kronen"` |
