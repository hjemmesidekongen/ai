...
Kronen transforms Claude Code from a stateless coding assistant into a
...
kronen (previously split across task-planner and agency plugins).
...
Kronen is the only plugin that other plugins can reference. This
...
Kronen is installed globally and activates automatically.
...
Kronen is built in phases. Each feature is implemented, tested, and
...
Kronen is one piece of a larger system designed to make Claude Code
work the way a professional development team does:

| Plugin | Purpose |
|--------|---------|
| **Kronen** | Foundation — memory, tracing, planning, governance |
