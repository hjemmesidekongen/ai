...
description: >
  ...
  user needs brand context, or when /brand:apply is invoked.
...
checkpoint:
  ...
  required_checks:
    - name: "brand_exists"
      ...
      fail_action: "Report: no brand found. Run /brand:create or /brand:audit first."
    - name: "brand_loaded"
...
5. If no brands exist, report and suggest `/brand:create`
