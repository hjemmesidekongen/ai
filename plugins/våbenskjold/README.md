...
| Command | Purpose |
|---------|---------|
| `/våbenskjold:create` | Create a new brand from scratch through research and sparring |
| `/våbenskjold:audit` | Codify an existing brand from materials and samples |
| `/våbenskjold:evolve` | Refresh or reinvent an existing brand |
| `/våbenskjold:apply` | Load a brand into context or wire it into a project |
| `/våbenskjold:status` | Show brand status and guideline summary |
...
Requires `kronen`. No other plugin dependencies.
