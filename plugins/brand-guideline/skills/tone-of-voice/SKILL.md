...
checkpoint:
  ...
  required_checks:
    - name: "spectrum_dimensions"
      verify: "voice.spectrum has all 4 dimensions (formality, humor, enthusiasm, technicality) with values 1-10"
      fail_action: "Present the missing dimension(s) and ask the user to place the brand on the scale"
    - name: "personality_attributes"
      verify: "voice.personality has at least 3 items, each with attribute, not, and description"
      fail_action: "Ask the user to describe one more way the brand speaks — 'We are ___ but not ___'"
    - name: "channel_variations"
      verify: "At least 2 channel-specific tone variations are captured in recovery_notes"
      fail_action: "Ask the user to describe how the tone shifts for at least 2 channels (website, social, email, support)"
    - name: "writing_samples"
      verify: "voice.writing_samples has at least 3 items, each with context, good, bad, and why"
      fail_action: "Generate additional writing samples from the personality and spectrum data and confirm with the user"
