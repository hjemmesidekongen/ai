...
checkpoint:
  ...
  required_checks:
    - name: "personas_count"
      verify: "audience.personas has at least 2 items"
      fail_action: "Ask the user to describe one more audience segment"
    - name: "persona_fields"
      verify: "Each persona has name, role, quote, goals (≥1), frustrations (≥1), and channels (≥1)"
      fail_action: "Walk through the incomplete persona and ask targeted questions for missing fields"
    - name: "primary_persona"
      verify: "The first persona in the array is the primary target, and primary_market is non-empty"
      fail_action: "Ask the user which persona is most important and reorder accordingly"
