---
name: dev-run
description: "Run the full smedjen pipeline from task intake to verified completion"
argument-hint: "TASK_DESCRIPTION [--dry-run]"
---

# Dev Run

Runs the smedjen-orchestrator skill — the full pipeline from task intake to verified completion.
...
3. **Invoke smedjen-orchestrator** skill with the task description and mode (execute or dry-run).
