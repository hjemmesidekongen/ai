...
3. In dry-run mode, read `plugins/taskflow/resources/test-data/sample-ticket.yml` as the source
...
3. Read plugins/taskflow/resources/test-data/sample-ticket.yml
