...
description: >
  ...
  context note. Triggered by /brainstorm:decide.
interactive: true
depends_on:
  - brainstorm-session
reads:
...
Extracts structured decisions from brainstorm sessions and co-authors them
with the user. This is NOT automated extraction — Claude proposes candidates,
the user confirms, adjusts, or rejects each one.
