...
_source:
  origin: "dev-engine"
  inspired_by: "claude-core context-manager"
  ported_date: "2026-03-10"
  iteration: 1
  changes: "Task-aware context assembly for dev-engine agent dispatch"
---
...
- **Knowledge skills** — dev-engine knowledge skills selected by tech stack match (e.g. `nextjs-app-router`, `prisma-patterns`).
