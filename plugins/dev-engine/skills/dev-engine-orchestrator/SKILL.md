...
# Dev Engine Orchestrator

Runs the full dev-engine pipeline from task intake to verified completion. Each stage is independently tracked so the pipeline can resume after failure without re-running completed stages.
