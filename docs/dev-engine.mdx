...
- [claude-core](/docs/claude-core) - the foundation plugin that dev-engine depends on
- [taskflow](/docs/taskflow) - task management that feeds acceptance criteria into the pipeline
- [Workflows](/docs/workflows) - recipes showing dev-engine in action
