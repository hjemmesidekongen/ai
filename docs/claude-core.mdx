...
**Version:** 0.3.0 · **35 skills** · **13 commands** · **12 agents** · **16 hooks**
...
Turn ideas into structured execution plans with dependency resolution and parallel dispatch.
...
The planning engine handles the hard parts: dependency ordering, file-ownership isolation (so parallel agents don't conflict), and automatic verification gates between waves.
...
claude-core runs 16 hooks across 6 event types:
