...
- **claude-core** (`plugins/claude-core/`) — Foundation plugin: planning, brainstorm, tracing, memory governance, roadmap, doc governance, creator/reviewer tooling, and validation agents (18 skills, 9 commands, 3 agents).
...
plugins/
  claude-core/                       # Foundation plugin (18 skills, 9 commands, 3 agents)
    .claude-plugin/
